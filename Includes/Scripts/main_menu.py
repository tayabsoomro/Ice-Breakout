...
# Function "main_menu" **************************************************
# **********************************************************************
def main_menu(screen, menu, x_pos = 100, y_pos = 100, font = None,
	...
	HOW TO INTERACT
	===============
	After called main_menu(), the User MUST choose an Menupoint. The
	...
	menu_font = pygame.font.Font('Includes/Fonts/IGLOO.ttf', size)
	if font == None:
		myfont = pygame.font.Font('Includes/Fonts/IGLOO.ttf', size)
	else:
	...
	for i in menu:
		if renderWithChars == False:
			text =  menu_font.render(str(cursorpos + 1)+".  " + i,
				True, fgcolor)
		else:
			text =  menu_font.render(chr(char)+".  " + i,
				True, fgcolor)
			char += 1
	...
	# Draw the ">", the Cursor
	cursorpos = 0
	cursor = menu_font.render("O", True, cursorcolor)
