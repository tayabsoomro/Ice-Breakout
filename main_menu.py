...
def main_menu(screen, menu, x_pos = 100, y_pos = 100, distance = 2.4, fgcolor = (255,255,255), exitAllowed = True):
	...
	defaultFont = pygame.font.SysFont(None, size)
	cursorpos = 0
	...
	# Draw the ">", the Cursor
	cursorpos = 0
	cursor = pygame.image.load('Includes/Images/arrow.png')
